...
from ._shared import _paginate, _request, _short_id, JulesAPIError
...
def register_patch_tools(mcp: FastMCP) -> None:
    mcp.tool(tags={"domain:jules"})(jules_patch_summary)
    mcp.tool(tags={"domain:jules"})(jules_patch_apply)
    mcp.tool(tags={"domain:jules"})(jules_patch)
