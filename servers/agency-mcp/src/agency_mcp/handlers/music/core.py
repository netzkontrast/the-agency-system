...
async def update_track_field(
    ...
    from agency_mcp.handlers.music.gates import _check_pre_gen_gates_for_track
    from agency_mcp.handlers.music.status import (
        _CANONICAL_TRACK_STATUS,
        _VALID_TRACK_STATUSES,
        _validate_track_transition,
    )
    from agency_mcp.handlers.music.text_analysis import _load_artist_blocklist
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_find_album", tags=["domain:music"])(find_album)
    mcp.tool(name="music_list_albums", tags=["domain:music"])(list_albums)
    mcp.tool(name="music_get_track", tags=["domain:music"])(get_track)
    mcp.tool(name="music_list_tracks", tags=["domain:music"])(list_tracks)
    mcp.tool(name="music_get_session", tags=["domain:music"])(get_session)
    mcp.tool(name="music_update_session", tags=["domain:music"])(update_session)
    mcp.tool(name="music_rebuild_state", tags=["domain:music"])(rebuild_state)
    mcp.tool(name="music_get_config", tags=["domain:music"])(get_config)
    mcp.tool(name="music_get_python_command", tags=["domain:music"])(get_python_command)
    mcp.tool(name="music_get_ideas", tags=["domain:music"])(get_ideas)
    mcp.tool(name="music_search_text", tags=["domain:music"])(search)
    mcp.tool(name="music_get_pending_verifications", tags=["domain:music"])(get_pending_verifications)
    mcp.tool(name="music_resolve_path", tags=["domain:music"])(resolve_path)
    mcp.tool(name="music_resolve_track_file", tags=["domain:music"])(resolve_track_file)
    mcp.tool(name="music_list_track_files", tags=["domain:music"])(list_track_files)
    mcp.tool(name="music_extract_section", tags=["domain:music"])(extract_section)
    mcp.tool(name="music_update_track_field", tags=["domain:music"])(update_track_field)
    mcp.tool(name="music_get_album_progress", tags=["domain:music"])(get_album_progress)
