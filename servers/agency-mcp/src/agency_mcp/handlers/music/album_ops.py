...
async def music_validate_album_structure(
    album_slug: str,
    checks: str = "all",
) -> str:
...
async def music_create_album_structure(
    album_slug: str,
    genre: str,
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(tags={"domain:music"})(music_get_album_full)
    mcp.tool(tags={"domain:music"})(music_validate_album_structure)
    mcp.tool(tags={"domain:music"})(music_create_album_structure)
