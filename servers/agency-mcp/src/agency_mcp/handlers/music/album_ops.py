...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_get_album_full", tags=["domain:music"])(get_album_full)
    mcp.tool(name="music_validate_album_structure", tags=["domain:music"])(validate_album_structure)
    mcp.tool(name="music_create_album_structure", tags=["domain:music"])(create_album_structure)
