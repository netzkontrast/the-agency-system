...
from agency_mcp.handlers.music._shared import _safe_json, get_plugin_version as _read_plugin_version
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_get_plugin_version", tags=["domain:music"])(get_plugin_version)
    mcp.tool(name="music_check_venv_health", tags=["domain:music"])(check_venv_health)
    mcp.tool(name="music_health_check", tags=["domain:music"])(health_check)
    mcp.tool(name="music_diagnose_system", tags=["domain:music"])(diagnose)
