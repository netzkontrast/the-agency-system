...
from agency_mcp.handlers.music.processing import _helpers
from agency_mcp.handlers.music.processing import _album_stages
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_analyze_audio", tags=["domain:music"])(analyze_audio)
    mcp.tool(name="music_qc_audio", tags=["domain:music"])(qc_audio)
    mcp.tool(name="music_master_audio", tags=["domain:music"])(master_audio)
    mcp.tool(name="music_fix_dynamic_track", tags=["domain:music"])(fix_dynamic_track)
    mcp.tool(name="music_master_with_reference", tags=["domain:music"])(master_with_reference)
    mcp.tool(name="music_master_album", tags=["domain:music"])(master_album)
    mcp.tool(name="music_render_codec_preview", tags=["domain:music"])(render_codec_preview)
    mcp.tool(name="music_mono_fold_check", tags=["domain:music"])(mono_fold_check)
    mcp.tool(name="music_prune_archival", tags=["domain:music"])(prune_archival)
    mcp.tool(name="music_measure_album_signature", tags=["domain:music"])(measure_album_signature)
    mcp.tool(name="music_album_coherence_check", tags=["domain:music"])(album_coherence_check)
    mcp.tool(name="music_album_coherence_correct", tags=["domain:music"])(album_coherence_correct)
