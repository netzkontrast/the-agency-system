...
from agency_mcp.tools.mastering.album_signature import build_signature, compute_anchor_deltas
...
from agency_mcp.tools.mastering.layout import (
    LayoutError,
...
from agency_mcp.tools.mastering.signature_persistence import (
    SIGNATURE_FILENAME,
    SignaturePersistenceError,
    read_signature_file,
    write_signature_file,
)
from agency_mcp.tools.mastering.adm_validation import (
    ADMValidationError,
    check_aac_intersample_clips as _adm_check_fn_default,
    render_adm_validation_markdown,
)
from agency_mcp.tools.mastering.metadata import (
    MetadataEmbedError,
    embed_wav_metadata as _embed_wav_metadata_fn_default,
)
from math import gcd
from scipy import signal
from agency_mcp.tools.mastering.master_tracks import limit_peaks
...
async def _stage_mastering(ctx: MasterAlbumCtx) -> str | None:
    ...
    from agency_mcp.tools.mastering.master_tracks import master_track as _master_track
...
async def _stage_verification(ctx: MasterAlbumCtx) -> str | None:
    ...
    import numpy as np
    from agency_mcp.tools.mastering.analyze_tracks import analyze_track
    from agency_mcp.tools.mastering.fix_dynamic_track import fix_dynamic
...
async def _stage_coherence_check(ctx: MasterAlbumCtx) -> str | None:
    ...
    from agency_mcp.tools.mastering.coherence import build_correction_plan
...
async def _stage_mastering_samples(ctx: MasterAlbumCtx) -> str | None:
    ...
    """
    from agency_mcp.tools.mastering.master_tracks import GENRE_PRESETS, _PRESET_DEFAULTS
...
async def _stage_archival(ctx: MasterAlbumCtx) -> str | None:
    ...
    from agency_mcp.tools.mastering.archival import prune_archival_orphans
