...
from agency_mcp.handlers.music import text_analysis as _text_analysis
...
def register(mcp: Any) -> None:
    mcp.tool(name="music_run_pre_generation_gates", tags=["domain:music"])(run_pre_generation_gates)
    mcp.tool(name="music_check_streaming_lyrics", tags=["domain:music"])(check_streaming_lyrics)
