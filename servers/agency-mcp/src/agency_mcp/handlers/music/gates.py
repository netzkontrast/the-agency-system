...
from . import _shared
from . import text_analysis as _text_analysis
from ._shared import (
    _SECTION_TAG_RE,
...
async def music_run_pre_generation_gates(
    album_slug: str,
    track_slug: str = "",
) -> str:
...
async def music_check_streaming_lyrics(album_slug: str, track_slug: str = "") -> str:
...
def register(mcp: Any) -> None:
    mcp.tool(tags={"domain:music"})(music_run_pre_generation_gates)
    mcp.tool(tags={"domain:music"})(music_check_streaming_lyrics)
