...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_generate_promo_videos", tags=["domain:music"])(generate_promo_videos)
    mcp.tool(name="music_generate_album_sampler", tags=["domain:music"])(generate_album_sampler)
