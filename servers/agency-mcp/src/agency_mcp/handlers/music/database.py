...
from agency_mcp.handlers.music._shared import _find_album_or_error, _normalize_slug, _safe_json
...
def register(mcp: Any) -> None:
    mcp.tool(name="music_db_init", tags=["domain:music"])(db_init)
    mcp.tool(name="music_db_list_tweets", tags=["domain:music"])(db_list_tweets)
    mcp.tool(name="music_db_create_tweet", tags=["domain:music"])(db_create_tweet)
    mcp.tool(name="music_db_update_tweet", tags=["domain:music"])(db_update_tweet)
    mcp.tool(name="music_db_delete_tweet", tags=["domain:music"])(db_delete_tweet)
    mcp.tool(name="music_db_search_tweets", tags=["domain:music"])(db_search_tweets)
    mcp.tool(name="music_db_sync_album", tags=["domain:music"])(db_sync_album)
    mcp.tool(name="music_db_get_tweet_stats", tags=["domain:music"])(db_get_tweet_stats)
