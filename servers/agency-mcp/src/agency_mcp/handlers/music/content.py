...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_load_override", tags=["domain:music"])(load_override)
    mcp.tool(name="music_get_reference", tags=["domain:music"])(get_reference)
    mcp.tool(name="music_format_for_clipboard", tags=["domain:music"])(format_for_clipboard)
