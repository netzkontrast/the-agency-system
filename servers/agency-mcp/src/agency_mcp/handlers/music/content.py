...
async def music_load_override(override_name: str) -> str:
...
async def music_get_reference(name: str, section: str = "") -> str:
...
async def music_format_for_clipboard(
    album_slug: str,
    track_slug: str,
    content_type: str,
) -> str:
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(tags={"domain:music"})(music_load_override)
    mcp.tool(tags={"domain:music"})(music_get_reference)
    mcp.tool(tags={"domain:music"})(music_format_for_clipboard)
