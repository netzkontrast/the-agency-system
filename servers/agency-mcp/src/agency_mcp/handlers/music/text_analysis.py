...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_check_homographs", tags=["domain:music"])(check_homographs)
    mcp.tool(name="music_scan_artist_names", tags=["domain:music"])(scan_artist_names)
    mcp.tool(name="music_check_pronunciation_enforcement", tags=["domain:music"])(check_pronunciation_enforcement)
    mcp.tool(name="music_check_explicit_content", tags=["domain:music"])(check_explicit_content)
    mcp.tool(name="music_extract_links", tags=["domain:music"])(extract_links)
    mcp.tool(name="music_get_lyrics_stats", tags=["domain:music"])(get_lyrics_stats)
    mcp.tool(name="music_check_cross_track_repetition", tags=["domain:music"])(check_cross_track_repetition)
