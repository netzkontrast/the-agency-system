...
async def music_check_homographs(text: str) -> str:
    ...
    err = _check_text_length(text, "music_check_homographs")
    if err:
        return err
...
async def music_scan_artist_names(text: str) -> str:
    ...
    err = _check_text_length(text, "music_scan_artist_names")
    if err:
        return err
...
async def music_check_pronunciation_enforcement(
    album_slug: str,
    track_slug: str,
) -> str:
...
async def music_check_explicit_content(text: str) -> str:
    ...
    err = _check_text_length(text, "music_check_explicit_content")
    if err:
        return err
...
async def music_get_lyrics_stats(
    album_slug: str,
    track_slug: str = "",
) -> str:
...
async def music_check_cross_track_repetition(
    album_slug: str,
    min_tracks: int = 3,
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(tags={"domain:music"})(music_check_homographs)
    mcp.tool(tags={"domain:music"})(music_scan_artist_names)
    mcp.tool(tags={"domain:music"})(music_check_pronunciation_enforcement)
    mcp.tool(tags={"domain:music"})(music_check_explicit_content)
    mcp.tool(tags={"domain:music"})(music_extract_links)
    mcp.tool(tags={"domain:music"})(music_get_lyrics_stats)
    mcp.tool(tags={"domain:music"})(music_check_cross_track_repetition)
