...
from agency_mcp.handlers.music._shared import _normalize_slug, _resolve_audio_dir, _safe_json
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_reset_mastering", tags=["domain:music"])(reset_mastering)
    mcp.tool(name="music_cleanup_legacy_venvs", tags=["domain:music"])(cleanup_legacy_venvs)
    mcp.tool(name="music_migrate_audio_layout", tags=["domain:music"])(migrate_audio_layout)
