...
from agency_mcp.handlers.music._shared import _safe_json
...
async def promote_idea(
    ...
    from agency_mcp.handlers.music.album_ops import create_album_structure
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_create_idea", tags=["domain:music"])(create_idea)
    mcp.tool(name="music_update_idea", tags=["domain:music"])(update_idea)
    mcp.tool(name="music_promote_idea", tags=["domain:music"])(promote_idea)
