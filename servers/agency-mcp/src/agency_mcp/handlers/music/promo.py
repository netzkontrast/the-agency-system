...
from ._shared import _find_album_or_error, _safe_json
from ._shared import _PROMO_FILES
...
async def music_get_promo_status(album_slug: str) -> str:
...
async def music_get_promo_content(album_slug: str, platform: str) -> str:
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(tags={"domain:music"})(music_get_promo_status)
    mcp.tool(tags={"domain:music"})(music_get_promo_content)
