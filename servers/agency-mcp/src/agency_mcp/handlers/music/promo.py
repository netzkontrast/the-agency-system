...
from agency_mcp.handlers.music._shared import _find_album_or_error, _safe_json
from agency_mcp.handlers.music.status import _PROMO_FILES
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_get_promo_status", tags=["domain:music"])(get_promo_status)
    mcp.tool(name="music_get_promo_content", tags=["domain:music"])(get_promo_content)
