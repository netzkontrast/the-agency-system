...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_transcribe_audio", tags=["domain:music"])(transcribe_audio)
    mcp.tool(name="music_prepare_singles", tags=["domain:music"])(prepare_singles)
    mcp.tool(name="music_create_songbook", tags=["domain:music"])(create_songbook)
    mcp.tool(name="music_publish_sheet_music", tags=["domain:music"])(publish_sheet_music)
