...
async def music_extract_distinctive_phrases(
    text: str,
    max_phrases: int = 0,
    ...
    err = _check_text_length(text, "music_extract_distinctive_phrases")
    if err:
        return err
...
async def music_count_syllables(text: str) -> str:
    ...
    err = _check_text_length(text, "music_count_syllables")
    if err:
        return err
...
async def music_analyze_readability(text: str) -> str:
    ...
    err = _check_text_length(text, "music_analyze_readability")
    if err:
        return err
...
async def music_analyze_rhyme_scheme(text: str) -> str:
    ...
    err = _check_text_length(text, "music_analyze_rhyme_scheme")
    if err:
        return err
...
async def music_validate_section_structure(text: str) -> str:
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(tags={"domain:music"})(music_extract_distinctive_phrases)
    mcp.tool(tags={"domain:music"})(music_count_syllables)
    mcp.tool(tags={"domain:music"})(music_analyze_readability)
    mcp.tool(tags={"domain:music"})(music_analyze_rhyme_scheme)
    mcp.tool(tags={"domain:music"})(music_validate_section_structure)
