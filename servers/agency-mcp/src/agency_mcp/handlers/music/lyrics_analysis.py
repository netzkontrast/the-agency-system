...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_extract_distinctive_phrases", tags=["domain:music"])(extract_distinctive_phrases)
    mcp.tool(name="music_count_syllables", tags=["domain:music"])(count_syllables)
    mcp.tool(name="music_analyze_readability", tags=["domain:music"])(analyze_readability)
    mcp.tool(name="music_analyze_rhyme_scheme", tags=["domain:music"])(analyze_rhyme_scheme)
    mcp.tool(name="music_validate_section_structure", tags=["domain:music"])(validate_section_structure)
