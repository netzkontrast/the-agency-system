...
from agency_mcp.handlers.music._shared import _find_wav_source_dir, _is_path_confined, _safe_json
...
async def polish_and_master_album(
    ...
    """
    from agency_mcp.handlers.music.processing.audio import master_album
...
def register(mcp: Any) -> None:
    ...
    mcp.tool(name="music_polish_audio", tags=["domain:music"])(polish_audio)
    mcp.tool(name="music_analyze_mix_issues", tags=["domain:music"])(analyze_mix_issues)
    mcp.tool(name="music_polish_album", tags=["domain:music"])(polish_album)
    mcp.tool(name="music_polish_and_master_album", tags=["domain:music"])(polish_and_master_album)
