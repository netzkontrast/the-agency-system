# Vendored from bitwize-music@v0.91.0: tools/mastering/qc_tracks.py
#!/usr/bin/env python3
...
def _check_truepeak(data: Any, rate: int, ceiling_db: float = -1.0) -> dict[str, str]:
    ...
    """
    from agency_mcp.tools.mastering.master_tracks import measure_true_peak
...
def _resolve_click_thresholds(genre: str | None) -> tuple[float, int]:
    ...
    from agency_mcp.tools.mastering.master_tracks import GENRE_PRESETS
