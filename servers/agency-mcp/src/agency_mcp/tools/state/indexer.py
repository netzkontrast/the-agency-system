# Vendored from bitwize-music@v0.91.0: tools/state/indexer.py
#!/usr/bin/env python3
"""
...
from agency_mcp.tools.shared.config import CONFIG_PATH
from agency_mcp.tools.shared.logging_config import setup_logging
from agency_mcp.tools.state.parsers import (
    parse_album_readme,
    parse_ideas_file,
    parse_skill_file,
    parse_track_file,
