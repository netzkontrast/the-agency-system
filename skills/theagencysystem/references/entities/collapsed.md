...
- **function:** collapsed
- **class:** EP
- **the-eleven label:** The Collapsed One
- **novel name:** Moros
- **tier:** core
- **layers:** all
...
## Visual grammar  (role only — no name)
Extremely thick charcoal, asphalt lacquer, heavy impasto acrylic that warps the paper. Abyssal Black veined faintly with Bruise Purple + Sluggish Indigo — bruises, stagnation, dying tissue, absolute light-consumption. No line, only sinking masses dragged downward with a spatula or bare fingers ("down-moshing"). Extreme bottom-heaviness, a weighing vacuum above. At catatonia: ~100% suffocating charcoal.

## Per-state notes
- S1: The instant the nervous system gave up; latent, leaden, withdrawn.
- S3: (lead at peak) Kollaps-Peak — Flame/Corrupted; carries the unbearable so the system doesn't rupture.
- S4: The integrator alone does not fear him; what he carried can begin to be held.
