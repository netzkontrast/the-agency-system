...
- **function:** child_freeze
- **class:** EP
- **the-eleven label:** The Child-Freeze
- **novel name:** Kiko
- **tier:** core
- **layers:** all
...
Finest finliners (0.03mm), hard pencil on dead-dark-gray paper; pen set down hesitantly, trembling. Frostbite Cyan + Dead Pixel Gray — sickly pale cold, watery white/pale-blue ink, no warm pigment. Fine uncontrolled micro-jitter making no spatial progress — frozen static noise. Motif tiny, squeezed into the lowest corner, crushed by pressing black. At collapse: a grainy whiteout.

## Per-state notes
- S1: (lead) Latency/Freeze — held breath, Latency Violet; minimizes to vanish in the blind spot.
- S0: Hidden in the corner with the best sightline.
- S2: Terrified even when protection is for her; cannot bear the heat.
