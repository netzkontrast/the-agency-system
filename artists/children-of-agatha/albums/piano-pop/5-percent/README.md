...
> **„Erst die eigene Maske, sagen sie — / ich bin bei fünf Prozent."**

Strophen tragen die Lehrer-Konkretion; der Refrain bleibt **offen** (das „sagen sie" zitiert die Durchsage, kein anklagendes „du"). Im **Final-Refrain** kippt es nach innen: *„jetzt die eigene Maske — meine zuerst."* Titel „5%" lebt als gesungene Zeile („fünf Prozent"). *(lyric-writer darf verfeinern — Anker, kein Schloss.)*
...
- **Die Schüler:innen als Wofür** — gebraucht werden als letztes Signal
- **Bittersüß, nicht aufgeräumt** — ausstrecken, nicht geheilt; die Maske fällt nie

## Motifs & Threads

**Zwei Leitbilder:** der **Akku / fünf Prozent** (Körper) und die **Maske** (Geste). Weitere Bilder sind Einzel-Beats, keine wiederkehrenden Motive.
...
- **Schluss unaufgelöst** — ausstrecken, nicht aufgesetzt; die Musik löst es **nicht** auf.
- **Alltagsdeutsch, schlicht-direkt, korrekte Umlaute.** Keine 1:1-Übersetzung — Übertragung.
- Leitplanken Depression: siehe [RESEARCH.md](RESEARCH.md).
...
- **Kein aufgeräumter Recovery-Bogen**; Ende offen.
- **Würde, person-first**; kein Romantisieren, kein „tortured artist".
- **Keine Methoden-/Detailschilderung** von Suizid/Selbstverletzung.
- **Hilfe-Hinweis** in Beschreibung/Release-Notes, **nicht im Lyric**; plus „Kunst, kein Behandlungsratschlag".
...
Deutschland: 0800 111 0 111 / 0800 111 0 222, kostenlos & anonym).
```
