...
genres: ["pop-rap"]
tags: ["russian", "90s", "dance-rap", "eurodance", "bilingual", "deutsch", "russisch", "matroschka", "portrait", "character-study", "single"]
...
| **Release** | Single / Mini-Album (erweiterbar) |
| **Album** | Matroschka |
| **Genre** | [pop-rap](/genres/pop-rap/README.md) — russische 90er Dance-Rap, zweisprachig DE/RU |
| **Tracks** | 1 |
| **Status** | In Progress |
| **Explicit** | No |
| **Album-Typ** | Character Study (Erika) |
| **Für** | Erika (reale Person) — **kein** Cross-Ref zu anderen Werken |
| **Concept** | Matroschka — Schicht für Schicht; die Layer als Schutz UND Stärke, nie ablegen |
...
Eigenständiger Song für **Erika** (reale Person) — **kein** Cross-Ref zu anderen
Werken. Zentrale Metapher **Matroschka**: man lernt Erika **Schicht für Schicht**
kennen (wie eine Zwiebel); die Schichten sind **Schutz UND Stärke**, die sie **nie
ablegen soll**. Im Chaos die Frage „wer bin ich"; **noch nicht ganz in Sicherheit**;
mitten im **sich lösen**. Ganz innen, in der kleinsten Schale: die **kleine Erika**,
beschützt, schlummernd — ihr warmer, sehr empathischer Kern. Verzweiflung/
Unheilbarkeit als **Gefühl** (Riss/Narbe), **nie als Diagnose benannt**. Auf **typisch
russische Weise** tanzbar & trotzig-warm. Zweisprachig: deutsche Rap-Strophen +
russischer Hook.

**Zitierte In-Jokes (dürfen genau so vorkommen):** Gönnrika · Aaltanz / Leitaal /
bester Hüftschwung · Aalträume · glitschig · „Ich spüre Schwingungen" · „Vollkommene
Unterwerfung" · „Richtig und Wichtig" · 069 Frankfurt · alte russische Lieder ·
Gaming/Zocken · beste Umarmungen / mitfühlend / empathisch.

**Handling:** reale, private Person; **keine Diagnose** im Text; Verzweiflung
gerendert, nicht etikettiert; die Schichten als **Stärke** (würdevoll, nicht
pathologisierend).

## Structure

Einzel-Song als eigenes Single-Album (erweiterbar). Aufbau: Intro (RU) → Strophe
(DE-Rap) → Pre-Chorus → Hook (RU, tanzbar) → Strophe 2 → Hook → Bridge (die kleine
Erika, zärtlicher Drop) → Hook → Outro (RU/DE, offen-trotzig). **Stimme:** durchgehend
weiblich (Erika); Rap-Strophen deutsch, gesungener Hook russisch.

## Themes

- **Matroschka / Schicht für Schicht** — Layer als Schutz und Stärke, nie ablegen
- **Wer bin ich** — Identität im Chaos, mitten im „sich lösen", noch nicht in Sicherheit
- **Die kleine Erika** — der tief beschützte, sehr empathische Kern
- **Verzweiflung & Unheilbarkeit** — als Gefühl (Riss/Narbe), nie als Etikett
- **Trotzig-tanzbar (russisch)** — Wärme & Humor (Gönnrika, Aaltanz) gegen die Schwere
