...
| **Explicit** | No |
| **POV** | Kollektives Wir |
| **Role** | Dissoziations-Kern — verschwimmende Identität |
| **Fade Out** | 5s |
| **Target Duration** | — |
...
Der dissoziative Kern der Platte. Auf dem Höhepunkt kippt die Verschmelzung in Verwirrung: Keiner weiß mehr, welche Empfindung wem gehört. Trauer, Lust, Angst, Freude — alles zirkuliert im kollektiven Körper, ohne Besitzer. Die Frage „Wessen Gefühl ist das?" bekommt keine Antwort.

## Mood & Imagery

Gefühle wandern durch den Raum wie Rauch. Ein Lachen, das in Weinen kippt, ohne dass klar ist, wer. Spiegel ohne Reflexion. Verschwimmen, Doppelung, Echo.

## Musical Direction

- **Tempo**: ~74 BPM
- **Feel**: Schwebend, desorientiert; Bass und Stimmen verschwimmen ineinander
- **Instrumentation**: Sub-Bass mit Wow/Flutter-Anflug, verhallte Vocal-Fragmente, Delay-Schlieren, Orgel
...
```
dark trip hop, cinematic bass, ~74 BPM, disorienting and floating, deep sub-bass with subtle wow-and-flutter, smeared delay tails, reverbed vocal fragments, deadpan German spoken verse with a longing sung "we" hook, sacral organ, dissociative haze
```
...
- Identität bewusst verwischen: Stimmen pannen, doppeln, im Delay verlieren
- Strophe deadpan, Hook fragender/sehnsüchtiger als sonst
- Leichtes Wow/Flutter auf dem Bass — pharmazeutisch schief
