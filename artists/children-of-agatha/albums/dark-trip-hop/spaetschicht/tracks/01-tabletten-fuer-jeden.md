...
| **Explicit** | No |
| **POV** | Kollektives Wir |
| **Role** | Titeltrack / Opener — der Medikamentenwagen rollt, die Nacht beginnt |
| **Fade Out** | 5s |
| **Target Duration** | — |
...
Die Eröffnung. Der Medikamentenwagen rollt über den Flur, das Klappern der Becher ist der erste Beat. „Tabletten für jeden" — die Ausgabe als Eröffnung der Bar. Sardonische Vorfreude, das Ritual der Nacht setzt ein. Das kollektive Wir formiert sich aus den Einzelnen, die in der Schlange stehen.

## Mood & Imagery

Klappernde Plastikbecher, ein quietschendes Rad, Neonlicht-Brummen. Erwartung, ein dunkles Lächeln. Der Flur als Vorraum zur Feier. Kalte Töne, ein erster warmer Lichtfleck.

## Musical Direction

- **Tempo**: ~70–80 BPM
- **Feel**: Schleppend, ritualhaft anhebend; Sub-Bass-Herzschlag setzt ein
- **Instrumentation**: Sub-Bass, fragmentierte Breaks, Klappern/Foley (Becher, Wagenrad), ferne Orgel-Drone
...
```
dark trip hop, cinematic bass, 75 BPM, ritualistic sardonic, female deadpan spoken verse, longing sung "wir" chorus, layered close-mic vocals, sub-bass heartbeat, fragmented breaks, sacral organ drone, hospital reverb, all German, Burial, Anna von Hausswolff
```
...
```
no four-on-the-floor, no EDM drop, no bright pop production
```
...
- Strophen: deadpan/blunt Berliner Sprechgesang (Ikkimel-Haltung)
- Hook: klar gesungenes, sehnsüchtiges „Wir", geschichtete Stimmen
- Foley-Intro (Wagenrad, Becher) als rhythmisches Element
