...
| 2 | **The Nothing** | herz | the fragment/proto-host; the small-voice (1 break) | S1 · 0.91 | 58–64 · C minor | dark ambient; granular stutter, opacity-fade reverb tails | No up, no down, no time. "It is cold. I am small. Where is — nothing." Isolation as ground state; the only certainty is the threat of going out. ("It is cold. I am small." returns as a child-refrain in Track 10.) |
...
- **the small-voice:** young, gender-androgynous, head-voice only, whispered
  ...
  nothing."). **Never cute — mutilated by fear.**
