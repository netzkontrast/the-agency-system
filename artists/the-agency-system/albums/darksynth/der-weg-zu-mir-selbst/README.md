...
|-------|-------------|------------------------------|-------------|
| Title-Line („der Weg zu mir selbst lässt mich nicht in Frieden zu") | Zentrale Setzung; der Weg + die Friedlosigkeit als Doppel | T01 Chorus L4 (vollständig, ×2); T01 Outro L5–6 (fragmentiert: „Der Weg zu mir selbst — / lässt mich nicht in Frieden zu.") | T05 als gefilterter host-Echo, 4 Platzierungen: Intro (vollständig), nach V1 (nur „der weg zu mir selbst"), nach V3 (nur „lässt mich nicht in frieden zu"), Final Echo (vollständig wieder) — fragmentierend dann wieder zusammensetzend |
...
| Der Weg ohne Ende | Path-Imagery, die nie ankommt; rising harmony stacks ohne Auflösung | T01 Chorus L3 („Und je näher ich komme, desto weiter ist sie weg"); T01 Bridge L4–5 („und der Weg geht ohne mich weiter. / Er führt, aber er endet —") | T03 Chorus L3 als englische Hammer-Form: „No arrival, only weight. No arrival, only weight." (doubled hook with drop-out); T05 V1 als transformierte fighter-Erkenntnis „No arrival, only this. / This. Only this." — Gewicht fällt weg, Präsenz bleibt; T05 V2 collapsed past-tense: „es war ein weg / der war / er hat nicht aufgehört"; T05 Bridge↔Outro EN/DE call-response „No arrival / kein ankommen" |
| Kollaps als ehrlichster Ort | S3 als der einzige Moment, in dem nicht gelogen wird — nicht aus Tugend, sondern aus Erschöpfung (lügen kostet Kraft, die fehlt) | T04 Chorus L1+L3–4 (× 2) als Title-Hook + mechanische Wahrheitserklärung: „hier unten ist der ehrlichste ort / an dem nicht gelogen wird / weil keiner mehr / die kraft hat zu lügen"; T04 Outro L1 als finaler Title-Echo „hier ist der ehrlichste ort / ich trage / es trägt sich / weiter"; T04 V1 L1–4 als Sound-Distanz vom fighter-Peak: „er schreit oben / ich bin unten / das ist alles / was ich höre" | T05 (collapsed neben fighter, restlich) |
| Atem ohne Boden | Breath als unaufgelöster Puls / 92 BPM half-time als physiologische Konstante | T01 V2 L5 („Jemand in mir atmet anders — heute schon den ganzen Tag"); T01 V2 L2 („Geatmet. Mich nicht bewegt.") als somatischer Versuch ohne Aufgehen | T04 collapsed; T05 Outro „und der atem / und der atem" als unaufgelöster Atem + Final-Breath-Sample bei -inf-2dB im Fade (motif realized through FORM, not stated as phrase) |
...
| **„Auch nicht ich"** (neu in T01-v3) | Der Sprecher kommt nicht einmal zu sich selbst — schärfste Stelle des Albums | T01 Outro L4 (Setzung vor Title-Line-Bruch) | Implicit-realized in T05 V2 „du atmest noch / das ist viel / wir sitzen / nebeneinander" — die Adjazenz statt Identität; das „wir" ist die collapsed-Antwort auf „auch nicht ich" — nicht „endlich ich" sondern „immerhin neben". Final host-Echo bleibt geisterhaft, kein vollständig zurückgekehrter „ich". |
...
| 05 | Müde Wahrheit; Title-Line als gefilterter host-Echo (4 Platzierungen, fragmentierend); fighter erkennt „Blade was my hand" ohne S4-Repair; collapsed antwortet „du atmest noch / das ist viel"; erstes und einziges „wir" des Albums in V2 als Adjazenz, nicht Integration; Bridge↔Outro EN/DE call-response | Track 04's getragenes Gewicht + die ausgebrannte Erschöpfung der fighter; T03 Cut-Imagery wird zur self-recognition; T01 Title-Line kehrt als Ghost zurück | Schließt das Album auf der ermüdeten Klarsicht — keine Auflösung; endet auf Breath-Sample bei -inf-2dB |
...
| 05 | [*tired closer* (working title)](tracks/05-tired-closer.md) | fighter + collapsed (host-Echo) | EN+DE | S3↓ QUIET CLOSER; tired truth; Title-Line as filtered host-Echo (4 placements — fragmenting then reassembling); first and only „wir" of the album in V2; fighter's self-recognition „blade was my hand"; no S4; ends on the breath sample | In Progress |
