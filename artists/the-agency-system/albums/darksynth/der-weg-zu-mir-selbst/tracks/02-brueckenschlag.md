...
**Position:** 02 · **State:** S2 · **Lead voice:** integrator (ISH) · **Sprache:** Deutsch · **Energie:** ▅▅▅

Der integrator versucht den Brückenschlag — die ISH reicht in den Konflikt hinein, in den Pfad, den der host in Track 01 als Statement öffnete. Aber ihr Buffern wird von den EPs als Kontrolle missgedeutet. Das Versprechen — „die Hand, die heilt" — beginnt hier zum ersten Mal zu schneiden. Es ist der Moment, in dem klar wird: das Reichen selbst ist die Wunde.

**Lyrical Motifs (active here):**
- „Das Versprechen, das schneidet" — zentral, erstmalige Aussprache des Album-Kernmotivs
- „Weg ohne Ende" — die integrator beschreibt den Pfad, sieht aber selbst, dass er nicht ankommt
...
- **Tempo**: 92 BPM, half-time trap bounce
- **Feel**: ▅▅▅ — aufbauende Spannung, harmonische Schichten ohne Auflösung
