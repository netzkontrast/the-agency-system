...
work, see `voice-craft-principles.md`.
...
- Concrete nouns over abstract nouns (water, kettle, door — not longing, isolation, despair)
...
- **Emotion-naming adjectives**: *sad, lonely, devastated, angry, happy, proud, empty, scared*
- **Pop-mainstream love vocabulary**: *heart* (as feeling-organ), *forever, hold you, baby* (as endearment)
- **Generic darkness tropes**: *night, shadow* as standalone mood markers (only with structural justification)
- **Religious metaphor without earned narrative**: *sin, redemption, salvation* (unless system-mapped to the work's logic)
- **German diminutives**: *Herzchen, Stückchen, Liebling*
...
- Trauma states and recovery (cPTSD, DID, complex inner systems)
- Plurality as survival, not pathology
- Cyclic progress; recovery without final resolution
- Inner currents, somatic experience, the body as separate from the thinking self
- Honest pain rendered without melodrama
...
- Final-fusion / cured-as-endpoint trauma narratives
- Persecutor-as-monster framings (every part exists to protect, even violently)
- Pop love songs / party anthems / motivational anthems
...
- **Phonetic spelling lives in Suno lyrics only**, never in streaming lyrics.
